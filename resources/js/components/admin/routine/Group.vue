    ...
    export default{
        ...
        methods:{
            ...
            loadEditData(index) {
                ...
                this.formData.year = this.allDatas.groups[index].year.year;
                this.formData.class = this.allDatas.groups[index].student_class.title;
                this.formData.section = this.allDatas.groups[index].section.title;
